...
class nearCell: UICollectionViewCell {
    ...
    @IBOutlet fileprivate weak var disLabel: UILabel!
    @IBOutlet fileprivate weak var adressLabel: UILabel!
    @IBOutlet fileprivate weak var imageImageView: UIImageView!
